...
CATALOG = {
    ...
    "unsigned_qr_notice": {
        # One fixed Amharic + Afaan Oromo block, shown when the bot ASKS for the OTP
        # on the typed-FAN path. Identical in both slots so it renders exactly once
        # regardless of MESSAGE_LANGS (the render de-dupes identical blocks).
        "en": ("📄 *በFAN ቁጥር የወጣ PDF*\n"
               "\n"
               "⚠️ መረጃዎ ትክክል ነው፤ ነገር ግን QR ኮዱ Scan ሲደረግ ሊያስቸግር ይችላል።\n"
               "\n"
               "✅ የሚሠራ QR ለማግኘት የፋይዳ QR ስክሪንሾት ከቴሌብር ይላኩ።\n"
               "\n"
               "━━━━━━━━━━━━━━━━━━━━\n"
               "\n"
               "📄 *PDF Lakkoofsa FAN Irraa*\n"
               "\n"
               "⚠️ Odeeffannoon keessan sirriidha; garuu QR koodiin Scan irratti rakkisuu danda'a.\n"
               "\n"
               "✅ QR hojjetu argachuuf Fayda QR screenshot Telebirr irraa ergaa."),
        "am": ("📄 *በFAN ቁጥር የወጣ PDF*\n"
               "\n"
               "⚠️ መረጃዎ ትክክል ነው፤ ነገር ግን QR ኮዱ Scan ሲደረግ ሊያስቸግር ይችላል።\n"
               "\n"
