...
def t(key: str, **params) -> str:
    ...
    # A blank line between the two languages when either block is multi-line —
    # otherwise a long Amharic paragraph runs straight into the English one and the
    # whole thing reads as a wall. Short one-liners stay compact.
    sep = "\n\n" if any("\n" in p for p in parts) else "\n"
    body = sep.join(parts) if parts else _interp(entry.get("en") or f"[empty: {key}]", params)
...
CATALOG = {
    ...
    "qr_read_ok": {
        "en": "✅ QR code read successfully.\n\n👤 {name}\n🆔 FAN: {fan}",
        "am": "✅ የQR ኮዱ በተሳካ ሁኔታ ተነብቧል።\n\n👤 {name}\n🆔 FAN፦ {fan}"},
    "qr_required": {
        "en": ("📷 QR screenshot required\n"
               "\n"
               "Please send a screenshot of your Fayda (National ID) QR code from Telebirr.\n"
               "Sending the ID number alone is not enough for this service.\n"
               "\n"
               "📎 How to send it\n"
               "   1. Open Telebirr and go to Fayda (National ID)\n"
               "   2. Take a screenshot of the QR code\n"
               "   3. Send it here as a File:  Attach ➜ File\n"
               "\n"
               "ℹ️ Please send it as a File, not as a photo.\n"
               "Telegram compresses photos, which can make the QR code unreadable."),
        "am": ("📷 የQR ስክሪንሾት ያስፈልጋል\n"
               "\n"
               "እባክዎ ከቴሌብር የፋይዳ (ብሔራዊ መታወቂያ) QR ኮድዎን ስክሪንሾት አድርገው ይላኩ።\n"
               "የመታወቂያ ቁጥር ብቻ መላክ ለዚህ አገልግሎት በቂ አይደለም።\n"
               "\n"
               "📎 እንዴት እንደሚላክ\n"
               "   ፩. ቴሌብርን ከፍተው ወደ ፋይዳ (ብሔራዊ መታወቂያ) ይሂዱ\n"
               "   ፪. የQR ኮዱን ስክሪንሾት ያድርጉ\n"
               "   ፫. እዚህ እንደ ፋይል ይላኩ፦  Attach ➜ File\n"
               "\n"
               "ℹ️ እባክዎ እንደ ፋይል ይላኩ፤ እንደ ፎቶ አይላኩ።\n"
               "ቴሌግራም ፎቶዎችን ስለሚጨምቅ የQR ኮዱ ላይነበብ ይችላል።")},
    "unsigned_qr_notice": {
        "en": ("⚠️ Please note\n"
               "\n"
               "Your personal details on the PDF are correct and complete.\n"
               "\n"
               "However, the QR code on the card was not taken from your real ID — it is\n"
               "generated by this service. If someone scans it, it will not be accepted\n"
               "as genuine.\n"
               "\n"
               "✅ If you want a QR code that works when scanned, please send your Fayda QR\n"
               "screenshot from the Telebirr app."),
        "am": ("⚠️ ማሳሰቢያ\n"
               "\n"
               "በPDFዎ ላይ ያለው የግል መረጃዎ ትክክለኛና ሙሉ ነው።\n"
               "\n"
               "ነገር ግን በካርዱ ላይ ያለው QR ኮድ ከመታወቂያዎ ላይ የተወሰደ ሳይሆን በስርዓታችን\n"
               "የተዘጋጀ ነው። ስለዚህ ሌላ ሰው QR ኮዱን ሲቃኘው (scan) እንደትክክለኛ አይቀበለውም።\n"
               "\n"
               "✅ ሲቃኝ የሚሰራ QR ኮድ ከፈለጉ፣ እባክዎ ከቴሌብር መተግበሪያ የፋይዳ QR ኮድዎን\n"
               "ስክሪንሾት አድርገው ይላኩ።")},
    "qr_photo_compressed": {
        "en": ("⚠️ The QR code could not be read.\n"
               "\n"
               "Telegram compressed this image, so the QR code is no longer readable.\n"
               "\n"
               "📎 Please send the same screenshot as a File:\n"
               "   Attach ➜ File ➜ choose the screenshot"),
        "am": ("⚠️ የQR ኮዱን ማንበብ አልተቻለም።\n"
               "\n"
               "ቴሌግራም ምስሉን ስለጨመቀው የQR ኮዱ ሊነበብ አልቻለም።\n"
               "\n"
               "📎 እባክዎ ተመሳሳዩን ስክሪንሾት እንደ ፋይል ይላኩ፦\n"
               "   Attach ➜ File ➜ ስክሪንሾቱን ይምረጡ")},
